...
Z_spgl  = griddata(lambdas(:,1),lambdas(:,2),PRESS_spl,Xq,Yq);
%% Plot spgl PRESS
...
%% Save estimated surface parameters to table
clear Tab
Tab = table(Step,Terms);
for iBeta=1:L
...
table2latex(Tab,tableName);
%% Preliminaries for validation plots
