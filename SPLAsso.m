function [ pimat ] = SPLAsso( I, R, groups, l1, l2)
% SPARSEGROUPLASSO - Compute the sparse group lasso minimization
%       I       -   Target Data
%       R       -   Matrix of - Rows:Observations, Cols:Features
%       groups  -   Vector (Lx1) containing the group number corresponding
%       to each element
